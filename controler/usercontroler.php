...
$zira_type = pathinfo($newzira,PATHINFO_EXTENSION);
    ...
    if (move_uploaded_file($_FILES["profile-input"]["tmp_name"], $newprofile)) {
                    ...
                    $sql = "INSERT INTO user (name, email, gender, phone,passportno,visa,passport,profile,zira ) VALUES ('$name', '$email', '$gender', '$phone','$passportno','$visa','$passport','$profile','$zira')";
